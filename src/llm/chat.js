 ...
 */
export async function sendMessage(env, userMessage, conversationHistory = [], reportType) {
    try {
 ...
 */
export async function streamMessage(env, userMessage, conversationHistory = [], reportType) {
    const systemPrompt = reportType ? getReportPrompt(reportType) : SYSTEM_PROMPT;
    const messages = [
        {
            role: 'system',
 ...
 */
export async function generateReport(env, reportType, posData, filters) {
